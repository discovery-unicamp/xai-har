...
base_path = "../transitions_experiments_balanced"
...
path = "/home/patrick/Documents/Repositories/hiaac-m4-experiments/preliminary_analysis/datasets_preprocessing/data/transitions/initial_dataset_balanced/HAPT"
# users are the file names in path
users = sorted(os.listdir(path))

views = ["initial_dataset_balanced", "raw_balanced", "standartized_balanced"]
...
# experiments = list(product(transforms, datasets, users, views))
# invalid_combinations = []
# invalid_combinations += [
#     experiment for experiment in experiments 
#     if experiment[3] != 'standartized_balanced' 
#     and experiment[5] != None
# ]
# invalid_combinations += [
#     experiment for experiment in experiments 
#     if experiment[5] == None and experiment[4] != 'all'
# ]
...
# for experiment in experiments:
#     if experiment[4] == 'sensor':
#         experiment[5]['kwargs']['n_components'] = 12
#     elif experiment[4] == 'axis':
#         experiment[5]['kwargs']['n_components'] = 8
