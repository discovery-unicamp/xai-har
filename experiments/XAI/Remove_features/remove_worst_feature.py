...
def run_experiment(
    ...
    # while(tqdm(num_features > 0, total=total_features, desc=f"XAI: {xai_technique}, Classifier: {classifier}, Train: {dst_train}, Test: {dst_test}, Reduce: {reduce}")):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=False,
        default="results/feature_importance_remove_worst",
    )
